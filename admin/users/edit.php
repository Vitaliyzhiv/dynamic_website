    ...
    <div class="row">
        ...
        <div class="posts col-9">
            ...
            <div class="row m-3 title-table">
                <h2 class="text-center">Изменить пользователя</h2>
            </div>
            <div class="row m-3 add-post">
                ...
                <form action="edit.php" method="post">
                    ...
                    <div class="form-check mb-2">
                        <?php if ($role == 0): ?>
                            <input class="form-check-input" value="0" name="admin" type="checkbox" style="width: 16px; height: 16px; border: 2px solid #007bff; border-radius: 4px;">
                            <label class="form-check-label pt-1 ms-2" for="flexCheckChecked">
                                Change status to Admin
                            </label>
                        <?php else: ?>
                            <input class="form-check-input" value="1" name="user" type="checkbox" style="width: 16px; height: 16px; border: 2px solid #007bff; border-radius: 4px;">
                            <label class="form-check-label pt-1 ms-2" for="flexCheckChecked">
                    ...
                    <div class="col">
                        <button type="submit" name="edit-user" class="btn btn-primary mb-3">Изменить
                            пользователя
                        </button>
                    </div>
                </form>
